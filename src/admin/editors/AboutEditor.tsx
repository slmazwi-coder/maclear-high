    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex flex-col items-end gap-2">
          <button 
            onClick={save} 
            disabled={isScanning}
            className="flex items-center gap-2 bg-school-primary text-white px-6 py-2 rounded-xl font-medium hover:bg-green-800 disabled:opacity-50"
          >
            {isScanning ? (
      ...
      <section className="bg-gray-800 border border-gray-700 rounded-2xl p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={addParagraph} className="flex items-center gap-1 text-sm text-school-primary hover:underline"><Plus size={14} /> Add Paragraph</button>
        </div>
