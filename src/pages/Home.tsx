...
const stats = [
  { label: 'Matric Pass Rate', value: '97.2%', icon: TrendingUp },
  { label: 'Bachelors Pass', value: '42%', icon: Award },
  { label: 'Subject Distinctions', value: '25', icon: Users },
];
      ...
      <section className="py-12 bg-gray-50 -mt-10 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              <div className="p-4 bg-blue-50 rounded-xl text-school-primary">
                <stat.icon size={32} />
              </div>
              <div>
