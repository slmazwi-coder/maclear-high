  ...
  return (
    <div className="aspect-[3/4] sm:aspect-square w-full relative overflow-hidden bg-gray-100 rounded-2xl shadow-lg border border-gray-100 flex items-center justify-center group">
      {!hasError ? (
        ...
        <div className="absolute top-0 right-0 bg-school-primary/10 p-4 text-school-primary opacity-0 group-hover:opacity-100 transition-opacity">
        <Award size={24} />
      </div>
    </div>
  );
  ...
  return (
    <div className="py-16 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-32">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Celebrating our students who have left an indelible mark on Maclear High School history.
            </p>
          </div>
        ...
        <section>
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-school-primary flex items-center justify-center gap-3 mb-4">
              <Calendar className="text-school-primary" /> Top Achievers Timeline
            </h2>
